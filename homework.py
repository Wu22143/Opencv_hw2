...
class App():
    def __init__(self,window, window_title):
        ...
        self.menu_imageprocess.add_separator()
        ...
        self.menu_imageprocess.add_command(label='Find Contour',command=self.functions.find_contour)
        self.menu_imageprocess.add_command(label='Bounding Box',command=self.functions.bounding_box)
        self.menu_imageprocess.add_command(label='Convex Hull',command=self.functions.convex_hull)
        self.menu_imageprocess.add_separator()
        self.menu_imageprocess.add_command(label='Basic_Morphology',command=self.functions.basic_morphology)
        self.menu_imageprocess.add_command(label='Advanced Morphology',command=self.functions.Advanced_Morphology)
